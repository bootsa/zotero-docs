...
-   Java Runtime Environment (JRE) or Java Development Kit (JDK)
    ...
    -   On macOS, LibreOffice requires the JDK, not the JRE. See the [troubleshooting instructions](word_processor_plugin_troubleshooting#installation_error) for more information.
