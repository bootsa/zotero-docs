...
*Global search is currently in beta, with restricted public access. If you would like to test global search, you can email [support@zotero.org](mailto:support@zotero.org) to request access.*
