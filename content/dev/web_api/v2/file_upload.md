...
In addition to providing ways to [read](dev/web_api/v2/read_requests) and [write](dev/web_api/v2/write_requests) online library data, the Zotero Web API allows you to upload attachment files.
