...
The Read API is accompanied by a [Write API](dev/web_api/v1/write_api), which allows for the creation, modification and deletion of items and collections in online Zotero libraries.
