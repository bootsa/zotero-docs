...
Child attachments can also be created along with new top-level items by including the attachment object in the `attachments` array of the new item's metadata.
