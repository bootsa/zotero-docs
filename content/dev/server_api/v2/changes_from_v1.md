...
As [announced on zotero-dev](https://groups.google.com/d/msg/zotero-dev/egIdfVmWEeo/dkOfupK7EXoJ), version 2 of the [Zotero Server API](dev/server_api/v2/) brings many changes to enable [API-based syncing](dev/server_api/v2/syncing). While read-only clients may continue to work properly, clients that write to the API are likely to need updating.
