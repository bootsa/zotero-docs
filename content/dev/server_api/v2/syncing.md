...
-   Full-text content ([see separate documentation](dev/server_api/v2/fulltext_content))
-   Backoff instruction ([see read request documentation](dev/server_api/v2/read_requests#rate_limiting))
...
Upload objects which have `synced` set to `false`. Follow the instructions in [Updating Multiple Objects](dev/server_api/v2/write_requests#updating_multiple_objects), passing the current library version as `If-Unmodified-Since-Version`.
...
See [Deleting Multiple Collections](dev/server_api/v2/write_requests#deleting_multiple_collections), [Deleting Multiple Searches](dev/server_api/v2/write_requests#deleting_multiple_searches), [Deleting Multiple Items](dev/server_api/v2/write_requests#deleting_multiple_items), and [Deleting Multiple Tags](dev/server_api/v2/write_requests#deleting_multiple_tags). Pass the current library version as `If-Unmodified-Since-Version`.
