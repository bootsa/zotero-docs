...
Simply visit your Zotero account profile and [select a storage plan](/settings/storage).

### How can my entire lab or university or company sign up for Zotero Storage?

[Zotero Lab and Zotero Institution](/storage/institutions) provide members of your organization with unlimited personal and group cloud storage.
...
Detailed receipts/paid invoices for all recent payments for an individual storage subscription are available from your [storage settings page](/settings/storage).
...
You can switch the storage plan you're currently subscribed to at any time from your [storage settings](/settings/storage).
...
When you purchase a storage subscription, you may choose to renew or not to renew automatically each year. You can cancel automatic renewal at any time from your [storage settings](/settings/storage). You'll also receive a reminder email when your subscription is expiring or about to renew automatically.

### How do I cancel my subscription?

If you opted to renew your subscription automatically, you can cancel your next renewal by visiting your [storage settings](/settings/storage). As stated in the [Terms of Service](terms/terms_of_service), paid accounts are non-refundable. We implement this policy because costs incurred on our end fluctuate dramatically according to individual usage patterns.
